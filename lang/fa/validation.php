...
return [
    ...
    */
    ...
    'decimal' => ':attribute فیلد باید دارای :decimal اعشاری باشد.',
    ...
    'extensions' => 'فیلد :attribute باید دارای یکی از پسوندهای باشد: :values.',
    ...
    */
    ...
    'attributes' => [
        ...
        'religion'=>'دین',
        'tell'=>'تلفن ثابت',
        'tell2'=>'تلفن ثابت اضطراری',
        'military'=>'وضعیت نظام وظیفه',
        'military_title'=>'نوع معافیت',
        'condemnation'=>'سابقه محکومیت کیفری',
        'illness'=>'بیماری',
        'work_type'=>'متقاضی چه نوع کاری هستید',
        'work_evening'=>'آیا می توانید در ساعات غروب نیز کار کنید',
        'work_operant'=>'آیا در حال حاضر مشغول به کار هستید',
        'work_cooperate'=>'در کدام زمینه تمایل به همکاری دارید',
        'work_holidays'=>'آیا می توانید در ایام پایان هفته یا روزهای تعطیل نیز کار کنید',
        'insurance_history'=>'سابقه پرداخت بیمه',
        'work_insurance'=>'مدت پرداخت بیمه',
        'work_salary'=>'حقوق درخواستی',
        'it_office'=>'مجموعه آفیس',
        'it_accounting'=>'نرم افزارهای تخصصی حسابداری',
        'it_internet'=>'ویندوز، اینترنت و ایمیل',
        'it_social'=>'شبکه های اجتماعی',
        'it_designing'=>'نرم افزارهای طراحی',
        'it_it'=>'نرم افزارهای تخصصی حوزه IT',
        'it_note'=>'فهرست نرم افزارهایی که به آنها تسلط دارید',
        'reagent_name'=>'نام و نام خانوادگی',
        'reagent_job'=>'شغل',
