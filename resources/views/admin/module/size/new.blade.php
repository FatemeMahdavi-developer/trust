            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @component($prefix_component.".form",['action'=>route('admin.size.store'),'method'=>'post','upload_file'=>true])
                                @slot("content")
                                    ...
                                    @component($prefix_component."input",['name'=>'note','title'=>'متن','value'=>old('note'),'class'=>'w-50'])@endcomponent
