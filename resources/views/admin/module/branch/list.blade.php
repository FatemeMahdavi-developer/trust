                        ...
                        <div class="card-body">
                            @if(isset($branch[0]))
                                @component($prefix_component."navtab",['number'=>2,'titles'=>['لیست','جستجو']])
                                    @slot("tabContent0")
                                        @component($prefix_component."form",['action'=>route("admin.branch.action_all")])
                                            @slot("content")
                                                <table class="table text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        @canany(["delete_branch","update_branch"])
                                                    ...
                                                    @foreach($branch as $post)
                                                        <tr>
                                                            ...
                                                            <td>{{ $loop->iteration + $branch->firstItem() - 1 }}</td>
                                                            <td>{{$post["name"]}}</td>
                                                            ...
                                                            <td>
                                                                @can("update_branch")
                                                                <a href="{{route("admin.branch.edit",['branch'=>$post['id']])}}" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                                                @endcan
                                                                @can("delete_branch")
                                                                <a href="javascript:void(0)" data-href="{{route("admin.branch.destroy",['branch'=>$post['id']])}}" class="btn btn-danger btn-sm delete"><i class="fas fa-trash"></i></a>
                                                                @endcan
                                                            </td>
                                                        </tr>
                                                    @endforeach
